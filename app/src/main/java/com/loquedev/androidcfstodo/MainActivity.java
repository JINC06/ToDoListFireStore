package com.loquedev.androidcfstodo;
...
import com.loquedev.androidcfstodo.adapter.ListItemAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public MaterialEditText title, description; //they are public to access from adapter
    public boolean isUpdate = false;
    public String idUpdate = ""; //Id of the item need to update
